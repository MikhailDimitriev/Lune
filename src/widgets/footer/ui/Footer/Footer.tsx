...
export const Footer = () => {
  return (
    <footer className="border-t border-gold/25 bg-dark text-white">
      ...
      <div className="border-t border-white/10 py-6">
        <p className="mx-auto max-w-7xl px-4 text-center text-[11px] tracking-[0.2em] text-white/40 uppercase sm:px-6 lg:px-8">
